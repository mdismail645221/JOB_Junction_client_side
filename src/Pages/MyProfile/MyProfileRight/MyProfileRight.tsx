...
const MyProfileRight = () => {
  ...
  return (
    ...
    <Box sx={{ display: { xs: "none", md: "block" } }}>
      ...
      {/* top card */}
      <Box sx={{ display: { xs: "none", md: "block" }, border: "2px solid lightGray", backgroundColor: "white", borderRadius: "1em", marginLeft: "1.5em", p: "0 2em", height: "18.3em", mt: '1em' }}>

        <p style={{ marginTop: '1em', fontSize: "17px", fontWeight: "700" }}>Safety tips for your job search</p>
        <img style={{ width: "100%" }} src="https://visme.co/blog/wp-content/uploads/2020/02/header-1200.gif" alt="" />
      ...
      {/* 2nd card */}
      <Box sx={{ display: { xs: "none", md: "block" }, border: "2px solid lightGray", backgroundColor: "white", borderRadius: "1em", marginLeft: "1.5em", p: "0 2em", height: "18.3em", mt: '1em', textAlign: "center" }}>
        <p style={{ fontSize: "13px", marginTop: "2em" }}>Md Iktiup Mahmud, unlock your full potential with Job-Junction premium.</p>
      ...
      {/* 3rd card */}
      <Box sx={{ border: "2px solid lightGray", backgroundColor: "white", marginLeft: "1.5em", mt: '1em', borderRadius: "1em", height: '27.5em' }}>
