...
import { ACCEPTIGNORE, INVITATION, PROFILEINFOACCEPT, SHOWMOREBTN} from "./MyNetwork.styled";
      ...
      <Stack>
        ...
        <PROFILEINFOACCEPT>
          ...
          <Box sx={{
            ...
            <Avatar alt="Remy Sharp" src="https://i.ibb.co/4MnMYkJ/Joseph-Gray.png" />
            <Stack sx={{marginLeft: '10px'}}>
              <h5>Member’s name Jewel Hossain Fahim follows you and is inviting you to connect</h5>
