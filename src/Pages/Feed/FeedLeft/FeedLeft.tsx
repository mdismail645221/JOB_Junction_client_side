    ...
    <Box sx={{ display: { xs: "none", md: "block" }, mt: "1.5em" }}>
      ...
      >
        ...
        <Box sx={{ position: "relative" }}>
          <img
            style={{ width: "18em", borderRadius: "1em 1em 0 0" }}
            src="https://media.licdn.com/dms/image/D4D16AQH_CGCjTm6Emw/profile-displaybackgroundimage-shrink_200_800/0/1670523661007?e=1682553600&v=beta&t=jiMIVKh3GZDTTWamr5oLrJBTYHRSJJBhEyPJ7QkPEQc"
            alt=""
          />
        ...
        <Box sx={{ p: "1.3em 1em", ":hover": { backgroundColor: "#EBEBEB" } }}>
          ...
          >
            <GradeIcon
              sx={{ color: "#E7A33E", m: "0", ":hover": { color: "#F8C77E" } }}
            />
            <Typography
              sx={{ color: "black", fontSize: "12px", fontWeight: "700" }}
            >
